...
#--------------------------
#####Work on DNA mutations and Fig.1.A.#####
...
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5")
...
#DNA mutations C1
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C1")
#Indels
C1_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C1", pattern = ".indel.xlsx")
...
######Snps
C1_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C1", pattern = ".snp.xlsx")
...
#####DNA mutations C2
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C2")
#Indels#
C2_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C2", pattern = ".indel.xlsx")
...
#####Snps
C2_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/C2", pattern = ".snp.xlsx")
...
#####DNA mutations LD1
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD1")
######Indels
LD1_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD1", pattern = ".indel.xlsx")
...
####Snps
LD1_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD1", pattern = ".snp.xlsx")
...
####DNA mutations LD2
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD2")
####Indels
LD2_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD2", pattern = ".indel.xlsx")
...
####Snps
LD2_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/LD2", pattern = ".snp.xlsx")
...
####DNA mutations HD1
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD1")
#####Indels
HD1_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD1", pattern = ".indel.xlsx")
...
####Snps
HD1_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD1", pattern = ".snp.xlsx")
...
#####DNA mutations HD2
setwd("~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD2")
####Indels
HD2_intels_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD2", pattern = ".indel.xlsx")
...
#####Snps
HD2_snps_list <- list.files(path = "~/Documents/Cisplatin project/DNA mutations/Varscan outputs 0.5/HD2", pattern = ".snp.xlsx")
...
#######Barplot Epimut surv >1 vs. all epimut

#--------------------------
#####Fig.2.C - Focus on TRUE epimutations (lasting >1 generation)#####
...
ggtitle("")
#--------------------------
#####Fig.2.D - GO term enrichment analysis for RNA epimutations####
#Use of EnrichR
library(enrichR)
...
#--------------------------
#####Fig.2.E - RNA epimutations according to chromatin domain####
...
tiny_22G_newepi$Total=rowSums(cbind(tiny_22G_newepi$Up,tiny_22G_newepi$Down),na.rm=TRUE)
...
#--------------------------
#####Fig.3.B - 22G-RNAs epimutation duration#####
...
#--------------------------
#####Sup.Fig.2.A - Overlap 22G-RNA epimutation & gene exp.change####
...
tiny_piRNAs_newepi$Total=rowSums(cbind(tiny_piRNAs_newepi$Up,tiny_piRNAs_newepi$Down),na.rm=TRUE)
...
tiny_piRNAs_allLineage_rate <- ggplot(tiny_piRNAs_newepi, aes(x=Condition, y=Total, color = Condition,group=Condition)) + 
  geom_boxplot(fatten = 1, lwd = 1, width=0.5)+
  scale_color_manual(values=c("cornflowerblue", "darkgreen", "red"))+
  labs(y = "Number of new epimutations", x = "\nCondition")+
...
tiny_piRNAs_allLineage_rate
#--------------------------
#####Fig.3.D - piRNAs epimutations duration#####
...
tiny_miRNAs_newepi$Total=rowSums(cbind(tiny_miRNAs_newepi$Up,tiny_miRNAs_newepi$Down),na.rm=TRUE)
...
#--------------------------
#####Fig.3.F - miRNAs epimutations duration####
...
tiny_26G_newepi$Total=rowSums(cbind(tiny_26G_newepi$Up,tiny_26G_newepi$Down),na.rm=TRUE)
...
#--------------------------
#####Fig.3.H - 26G-RNAs epimutations duration####
...
#--------------------------
#####Fig.4.A to E - work on tRNAs-derived fragments####
#getcounts
...
#Fig.4.B          
plot(apply(NormHighPlus,1,median),col="red",lwd=2,type="l",ylab="total normalized reads",xlab="5_end relative  to tRNA start")
points(apply(NormContPlus,1,median),col="gray", lwd=2, type="l")
points(apply(NormLowPlus,1,median),col="orange",lwd=2, type="l")
legend("topright", c("median control","median low Cisplatin","median high Cisplatin"),col=c("red","orange","gray"),lwd=2,lty=1)
dev.copy(pdf, "tRNA_cleavage_points.pdf")
dev.off()

#Fig.4.C
vioplot(NormContPlus[41,],NormLowPlus[41,],NormHighPlus[41,],col=c("gray","orange","red"),names=c("control","low dose","high dose"), ylab="total normalized tRA 3' ends")
...
colnames(nameFiles)<-c("ID","DESeq_sizeFactor")
...
boxplot(apply(tRNA_normAbun[,ColTabCont],2,sum),apply(tRNA_normAbun[,ColTabLow],2,sum),apply(tRNA_normAbun[,ColTabHigh],2,sum)
        ,col=c("black","red","blue"),names=c("control","low cisplatin","high cisplatin"),ylab="total norm tRNA reads")
...
dev.off()
#--------------------------
#####Fig.4.F - Association tRNAs fragments & AGOs####
#Ago IP analysis
...
#--------------------------
#####Fig.4.G - tRNAs-derived fragments epimutations####
...
#--------------------------
#####Fig.4.H - Comparion 22G-RNAs vs. tRNAs fragments epimutations duration####
...
#--------------------------
#####Fig.5.A - GO term analysis for tRNAs associated genes####
#Data prep
setwd("~/Documents/Cisplatin project/Data_analysis/Analysis")
...
#--------------------------
#######Fig.5.B - Overlap tRNAs fragments epimutation & gene exp.change ######### 
...
#-------------
#######Fig.5.C - Concordance tRNAs fragments epimutation & gene exp.change####
